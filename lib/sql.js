...
function selectAllDepartments() {
  ...
  conn.promise().execute(`SELECT * FROM department;`)
    .then(([result]) => {
        console.log("\n View All Departments \n")
        console.table(result);
    })
...
function selectAllRoles() {
  ...
  conn.promise().execute(`SELECT * FROM role;`)
    .then(([result]) => {
      console.log("\n View All Roles \n")
      console.table(result);
    })
...
function selectAllEmployees() {
  ...
  conn.promise().execute(`SELECT e.last_name, e.first_name, r.title, r.salary, CONCAT(m.last_name, ', ', m.first_name) AS manager FROM employee e JOIN role r ON e.role_id = r.id LEFT JOIN employee m on e.manager_id = m.id;`)
    .then(([result]) => {
      console.log("\n View All Employees \n")
      console.table(result);
    })
