...
// function selectDeptsForRole() {
//   const conn = mysql.createConnection(connectionInfo);
//   let resultArray = [];

//   conn.promise().execute(`SELECT name, id value FROM department;`)
//     .then(([result]) => {
//       // resultArray =result; 
//       return result;
...
//     // })
//     // .catch((err) => console.log(err))
//   // console.log(resultArray)  // .then((result) => {promptRoleName})
//   return [{name: 'item1',value: 'b'},{name: 'item2',value: 'c'}];
// }
